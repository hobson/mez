...
env.ssl_domain = False  # env.domains[0]  # can only authenticate with SSL for a single domain
env.ssl_disabled = "#" if not env.ssl_domain or len(env.ssl_domain) > 1 else ""
